...
X, T = np.meshgrid(x,t)       #Meshgrid returns a rectangular grid of 2 1-D arrays. So here, X has the x coordinates of all the points in the grid and Y has the Y cordinates of all the points
